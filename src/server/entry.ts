...
import listings_get_5 from "./api/listings/GET";
import listings_post_6 from "./api/listings/POST";
import listings_id_get_7 from "./api/listings/[id]/GET";
import listings_id_reviews_get_8 from "./api/listings/[id]/reviews/GET";
import listings_id_reviews_post_9 from "./api/listings/[id]/reviews/POST";
import listings_id_save_post_10 from "./api/listings/[id]/save/POST";
import saved_get_11 from "./api/saved/GET";
import users_id_listings_get_12 from "./api/users/[id]/listings/GET";
import upload_post_13 from "./api/upload/POST";
import conversations_get_14 from "./api/conversations/GET";
import conversations_post_15 from "./api/conversations/POST";
import conversations_id_messages_get_16 from "./api/conversations/[id]/messages/GET";
import conversations_id_messages_post_17 from "./api/conversations/[id]/messages/POST";
import conversations_id_read_post_18 from "./api/conversations/[id]/read/POST";
import users_by_email_get_19 from "./api/users/by-email/GET";
import points_get_20 from "./api/points/GET";
import points_earn_post_21 from "./api/points/earn/POST";
import points_redeem_post_22 from "./api/points/redeem/POST";
import listings_id_sold_post_23 from "./api/listings/[id]/sold/POST";
// </api-imports>
...
app.get("/api/listings", listings_get_5);
app.post("/api/listings", listings_post_6);
app.get("/api/listings/:id", listings_id_get_7);
app.get("/api/listings/:id/reviews", listings_id_reviews_get_8);
app.post("/api/listings/:id/reviews", listings_id_reviews_post_9);
app.post("/api/listings/:id/save", listings_id_save_post_10);
app.get("/api/saved", saved_get_11);
app.get("/api/users/:id/listings", users_id_listings_get_12);
app.get("/api/users/by-email", users_by_email_get_19);
app.post("/api/upload", upload_post_13);
app.get("/api/conversations", conversations_get_14);
app.post("/api/conversations", conversations_post_15);
app.get("/api/conversations/:id/messages", conversations_id_messages_get_16);
app.post("/api/conversations/:id/messages", conversations_id_messages_post_17);
app.post("/api/conversations/:id/read", conversations_id_read_post_18);
app.get("/api/points", points_get_20);
app.post("/api/points/earn", points_earn_post_21);
app.post("/api/points/redeem", points_redeem_post_22);
app.post("/api/listings/:id/sold", listings_id_sold_post_23);
// </api-registrations>
...
if (import.meta.env.PROD) {
	...
	// @ts-ignore – entry-server is a Vite virtual module resolved at runtime
	(import("../entry-server") as Promise<any>).then(
		(mod) => {
